...
function TableQrCode({table, config, handleDelete, setIsAuthenticated}) {
    ...
    return (
        <>
            ...
            <td>
                <div ref={printRef} className={"print:scale-[2] print:origin-top-left"}
                     style={{padding: '16px', maxWidth: 192, width: "100%"}}>
            ...
            <td>
                ...
                />
                <button className="material-symbols-outlined text-red-700 border rounded text-4xl"
